...
CREATE TABLE IF NOT EXISTS delivery_settings (
  id INTEGER PRIMARY KEY CHECK (id = 1),
  common_fee DOUBLE PRECISION NOT NULL DEFAULT 8,
  estimated_time TEXT NOT NULL DEFAULT '35 a 55 min',
  store_address TEXT NOT NULL DEFAULT 'Av. das Pizzas, 1200 - Fortaleza, CE',
  store_lat DOUBLE PRECISION NOT NULL DEFAULT -3.7319,
  store_lng DOUBLE PRECISION NOT NULL DEFAULT -38.5267,
  max_radius_km DOUBLE PRECISION NOT NULL DEFAULT 8,
  per_km_fee DOUBLE PRECISION NOT NULL DEFAULT 1,
